CREATE OR ALTER VIEW AnaliticCifinConsolidadoRegistro
as 
SELECT 
   ...
   docs.Fecha,
   docs.Hora,
   CifinTest_Consolidado_ResumenPrincipal_Registro.PaqueteInformacion,
   CifinTest_Consolidado_ResumenPrincipal_Registro.NumeroObligaciones,
   CifinTest_Consolidado_ResumenPrincipal_Registro.TotalSaldo,
   CifinTest_Consolidado_ResumenPrincipal_Registro.ParticipacionDeuda,
   CifinTest_Consolidado_ResumenPrincipal_Registro.NumeroObligacionesDia,
   CifinTest_Consolidado_ResumenPrincipal_Registro.SaldoObligacionesDia,
   CifinTest_Consolidado_ResumenPrincipal_Registro.CuotaObligacionesDia,
   CifinTest_Consolidado_ResumenPrincipal_Registro.CantidadObligacionesMora,
   CifinTest_Consolidado_ResumenPrincipal_Registro.SaldoObligacionesMora,
   CifinTest_Consolidado_ResumenPrincipal_Registro.CuotaObligacionesMora,
   CifinTest_Consolidado_ResumenPrincipal_Registro.ValorMora
