CREATE OR ALTER VIEW AnaliticCifinDiferentePrincipal
as 
SELECT 
   docs.NumeroIdentificacion,docs.TipoIdentificacion,docs.id,CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.PaqueteInformacion,
   CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.NumeroObligaciones,CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.TotalSaldo,
   REPLACE(CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.[ParticipacionDeuda], '.', '') as ParticipacionDeudaSinPunto,
   CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.NumeroObligacionesDia,CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.SaldoObligacionesDia,
   CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.CuotaObligacionesDia,CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.CantidadObligacionesMora,
   CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.SaldoObligacionesMora,CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.CuotaObligacionesMora,
   CifinTest_Consolidado_ResumenDiferentePrincipal_Registro.ValorMora, docs.Fecha, docs.Hora
FROM OPENROWSET( 
       'CosmosDB',
       ...
       CONSULTA_CIFIN)
with ( 
      Consolidado_ResumenDiferentePrincipal_Registro  VARCHAR(MAX) '$.Consolidado.ResumenDiferentePrincipal.Registro',
 ...
 OUTER APPLY OPENJSON ( Consolidado_ResumenDiferentePrincipal_Registro )
		 WITH (
		...
		) AS CifinTest_Consolidado_ResumenDiferentePrincipal_Registro
INNER JOIN 
