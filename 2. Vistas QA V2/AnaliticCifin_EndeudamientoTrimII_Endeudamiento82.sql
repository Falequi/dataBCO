CREATE OR ALTER VIEW AnaliticCifinEndeudamientoTrimI_Endeudamiento82
as 
SELECT 
...
docs.Fecha,
docs.Hora,
CifinTest_Endeudamiento_EndeudamientoTrimII_Endeudamiento82.TipoMoneda,
REPLACE(CifinTest_Endeudamiento_EndeudamientoTrimII_Endeudamiento82.[NumeroContingencias], '.', '') as NumeroContingenciasSinPunto,
REPLACE(CifinTest_Endeudamiento_EndeudamientoTrimII_Endeudamiento82.[ValorContingencias], '.', '') as ValorContingenciasSinPunto,
REPLACE(CifinTest_Endeudamiento_EndeudamientoTrimII_Endeudamiento82.[CuotaEsperada], '.', '') as CuotaEsperadaSinPunto,
REPLACE(CifinTest_Endeudamiento_EndeudamientoTrimII_Endeudamiento82.[CumplimientoCuota], '.', '') as CumplimientoCuotaSinPunto
FROM OPENROWSET( 
       'CosmosDB',
       ...
       CONSULTA_CIFIN)
with ( Endeudamiento_EndeudamientoTrimII_Endeudamiento82 VARCHAR(MAX) '$.Endeudamiento.EndeudamientoTrimII.Endeudamiento82',
 ...
 OUTER APPLY OPENJSON ( Endeudamiento_EndeudamientoTrimII_Endeudamiento82 )
		 WITH (
		...
		) AS CifinTest_Endeudamiento_EndeudamientoTrimII_Endeudamiento82
INNER JOIN 
